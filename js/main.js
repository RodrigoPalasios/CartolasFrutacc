...
console.log('ok');
    ...
    var times = ['traga-cafe', 'pro-palestra', 'enter-di-melao-f-c', 'evolust-fc', 'jl-guimaraes', 'boston-colossenses', 'melanfutclube-fc', 'i-b-a-futebol-clube', 'igor-victorr', 'moisesfcfernando', 'yes-fcclube','guardatodas-esporte-clube','ta-na-roca-entao-capina','karistan-fc'];
    var qtdeTimesProcessados = 0;
